...
s_top <- data.frame(x = 2.7 + 0.5 * sin(-theta), y = 1.5 + 0.5 * cos(-theta))  # Top semi-circle
s_bottom <- data.frame(x = 2.7 + 0.5 * sin(theta), y = 0.5 + 0.5 * cos(theta))  # Bottom semi-circle
